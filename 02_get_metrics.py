...
with open('./result/prediction_StructSynthGPT4om-FT.json', 'r') as jsonfile:
    prediction_StructSynthGPT4om_FT = json.load(jsonfile)


prediction_Model = prediction_StructSynthGPT4om_FT
...
prediction_dict = {}
for pred in prediction_StructSynthGPT4om_FT:
...
alpha = 0.056748845  # Estimated from distance curve and alpha estimation
